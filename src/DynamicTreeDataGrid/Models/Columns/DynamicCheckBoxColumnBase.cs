...
public class DynamicCheckBoxColumnBase<TModel> : DynamicColumnBase<TModel, bool?>
	where TModel : class {
	/// <summary>
	...
	public DynamicCheckBoxColumnBase(object? header,
	...
	public DynamicCheckBoxColumnBase(object? header,
	                                 ...
	                                 Action<TModel, bool?>? setter = null,
	                                 GridLength? width = null,
	                                 CheckBoxColumnOptions<TModel>? options = null) : base(header, getter, setter,
		width, options ?? new()) {
		IsThreeState = true;
	}
